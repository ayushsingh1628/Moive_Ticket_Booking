...
public class Show_Details {
	...
	void display_show_timings()
	{
		...
		System.out.println();
		System.out.print("1. \tBatman  	  	\t\t 	10:20     11:30    17:30  ");
		System.out.println();
		System.out.print("2. \tSuperman   	\t\t\t 	10:45     12:30    16:30   ");
		System.out.println();
		System.out.print("3. \tAvengers    	\t\t\t 	10:00     11:45    15:30  ");
		System.out.println();
		System.out.print("4. \tSpies  		\t\t\t 	12:00     13:30    17:30  ");
		System.out.println();		
		System.out.print("5. \tStartUp     	\t\t\t 	09:20     11:30    17:30  ");
		System.out.println();
	}
	...
	String getmovie(int x)
	{
		switch(x)
		{
		case 1: return "Batman";
		case 2: return "Superman";
		case 3: return "Avengers";
		case 4: return "Spies";
